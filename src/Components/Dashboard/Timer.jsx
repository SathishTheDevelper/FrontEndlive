...
const EmployeeTimeTracker = () => {
  ...
  `);
    ...
    handleFinsihSend(senddata, form,setopenDrawer )
    setTotalSeconds(0);
    setBreakStartTime(0);
    setTotalBreakTime(0);
    setBreakType(null);
...
<div className="row mt-4">
                                     ...
                                     <div className="card text-center">
                                         <div className="card-body p-2">
                                             ...
                                             <h4 className="mb-0">
                                                 <i className={`fa-solid me- text-primary`}>{formatTime(totalSeconds)}</i>
                                             </h4>
                                         </div>
                                     </div>
                                 </div>
                                    <div className="col-xl-6 col-lg-6 col-sm-4 tg-base">
                                        <div className="card text-center">
                                            <div className="card-body p-2">
                                                ...
                                                <h4 className="mb-0">
                                                    <i className={`fa-solid me-1 fa-arrow`}>{formatTime(totalBreakTime)}</i>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
