     ...
     <>
      ...
      
      {
         ...
         <>
            ...
            <div className='col_2  g_10 col_1_sm g_5_sm col_1_md'>
      ...
      <div className="col-xl-4">
          ...
          <div className="card-body">
              ...
              <Card.Body>
              {
                ...
                <span className="pull-right me-2">Goal :{Math.round(item.target)}</span>
                <span className="pull-right me-2">Acheived :{Math.round(item.count)}</span>

                {/* <span className="pull-right">{calculatePercentage(item.count,item.target)}</span> */}

                <ProgressBar now={calculatePercentage(item.count,item.target)} variant={color[i]} />
                 </>
                })
              }
