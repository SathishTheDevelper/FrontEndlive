...
import {  Checkbox, Drawer, Form, Input, Select } from 'antd';
...
skill?.map((item,i) => {
  ...
  location?.map((item,i) => {
    ...
    return (
     ...
     <button onClick={()=>setAllcandidates([])} className='btn btn-info' > <i class="fa-solid fa-magnifying-glass me-1"></i> Back To Search</button>
