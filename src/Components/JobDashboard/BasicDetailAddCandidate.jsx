...
useEffect(() => {
 ...
 <Form.Item className="" label="Date of Submission" name="date_of_submission"
      rules={[
        {
            required:true,
      ...
      <div className="col_1 g_20_y col_1_sm g_5_sm salary" style={
        {
          marginTop: "-30px"
      }
      }>
...
{/*        <div className="resume-upload">
      ...
      >
              <Button className="btn_cancel" onClick={Assign? (e)=>handleClickEditAssign():""}>Cancel</Button>
