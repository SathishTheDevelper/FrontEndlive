...
import { useForm } from 'antd/lib/form/Form';
  ...
  const EditCandidatesPopup =() => {
    ...
    console.log("kkkk",CandidateView?.resume?.split("/")[1])
  ...
  const [resume, setResume] = useState("");
   ...
   let defaultFileList = [
    {
      uid: "1",
      name: CandidateView.resume,
      status: "done", // Set the status to 'done' for default files
      url: `https://apiv1.technoladders.com/${CandidateView?.resume}`, // Set the URL of the default file
    },
  ]; 
  const props = {
    name: "file",
