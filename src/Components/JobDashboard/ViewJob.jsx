 ...
 style={
    {
        cursor:"pointer"
                        ...
                        <div className="d-flex align-items-center">
                            {/* <Nav as="ul" className="nav nav-pills mix-chart-tab user-m-tabe" id="pills-tab">
                              ...
                              <Link to ={"/jobdetail"} className="btn btn-success btn-sm ms-2"
                            >Job Description
                            </Link>
        ...
        <div className="card-body px-0 pb-0">
         ...
         <span className="badge badge-primary light border-0 ms-1"> <i class="fa-solid fa-pen-to-square me-2" ></i> Change Status</span>
