...
const JobDashboard = () => {	
    ...
    const { setOpenaddjob,searchjob,handleChangeSearch,fetchJob,Loading,openJobs,handleChangestatus,pagination,handlePageChange,openaddjob}=useContext(JobContext)
