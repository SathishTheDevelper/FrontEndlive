...
//  Pie Chart ends here
 ...
 return( 
  ...
  <Drawer
    title="Assigncandidate To New Job"
    placement="right"
    onClose={handleOpenDrawerassign}
    closable={openAssign}
    size="large"
        ...
        >
         ...
         <Form.Item  name="phone_no"
          ...
          <Form.Item label="Total Experience" >
            <div className="d_f a_i_c j_c_c g_5 candidate  p_t_5">
          ...
          <div className="d_f a_i_c g_5 candidate p_t_10">
