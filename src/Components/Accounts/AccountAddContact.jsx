...
const AccountAddContacts = ({edit}) => {
  ...
  return (
   ...
   <div>
     ...
     <div>
                                <button htmlType="submit" className="btn btn-primary me-1" loading ={buttonloadingcontact} >Submit</button>
                                <button  className="btn btn-danger light ms-1" onClick={AddContactPopup}>Cancel</button>
                            </div>
