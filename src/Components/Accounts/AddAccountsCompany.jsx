  ...
  return (
   ...
   <div>
    ...
    >
     ...
     <div>
                                <button htmlType="submit" className="btn btn-primary me-1" loading ={buttonloadingaccount} >Submit</button>
                                <button  className="btn btn-danger light ms-1" onClick={AddCompanyPopup}>Cancel</button>
                            </div>
