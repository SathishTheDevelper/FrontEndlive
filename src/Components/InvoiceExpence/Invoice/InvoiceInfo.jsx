...
export default function InvoiceDetails(props) {
   const {invoiceSingle,InvoiceLoading,handleopenpaymnet}=useContext(InvoiceExpenceContext)
...
//   },[props.invoiceId])
  ...
  const items = [
    {
      key: '1',
      extra: <label onClick={handleopenpaymnet}>+ Record Payment</label>,
      label: `Payments Received: 0 `,
      children: invoiceDetails?.payment_details?.length?<table className='table'>
        <thead>
          <tr>
            <th>Sl#</th>
            {/* <th>Id</th> */}
  ...
  return (
      ...
      <div className='container-fluid'>
    {
      ...
      <div className='d_f j_c_s_b g_10 m_t_10'>
         ...
         <div>
     <span className="badge badge-secondary light border-0 me-1">Sent</span>
     ...
     <table style={{ width: '100%', borderCollapse: 'collapse',  }}>
      <tbody>
        ...
        <tr style={{ backgroundColor: '#f8f9ff' }}>
          <td style={{ padding: '20px 12px', width:"50%" }}>PO: APRL-3434-34343</td>
    ...
    <tbody>
      {
        invoiceSingle?.tableData?.map((item)=>(
          ...
          <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>{item?.amount}</td>
        </tr>
        ))
      }
      <tr style={{ textAlign: "center" }}>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>1</td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>
          For the month of Januray
        </td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>168</td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>2000</td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>18</td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>64.480</td>
        <td style={{ padding: 8, border: "1px solid #d5d9f3" }}>336999</td>
      </tr>
      <tr>
        <td colSpan={6}></td>
    ...
    <p style={{ margin: 0, textAlign: "right", fontWeight: "bold" }}>
      ...
      <tr>
        ...
        >
          ...
          <p style={{ margin: 0 }}>{invoiceSingle?.terms_and_condition||""}</p>
        </td>
      </tr>
    </tbody>
  </table>
