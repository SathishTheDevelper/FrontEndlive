      ...
      <Form form={form}>
            ...
            <div>
                ...
                <div className='d_f g_15 p_t_15'>
                  <p>
                    <a href={`${BASE}${adminLoginData?.pan_file?.path}` } target="blank" className='employeeDashBoard-personalLabel'>Pan Card  <img className='m_b_5 personal-aadhar-size' src={Pan}/></a></p> 
                    <label className='p_t_50'>{adminLoginData?.pan_num}</label>
                </div>
                <div className='d_f g_15 p_t_15'>
                  <p>
                    <a href={`${BASE}${adminLoginData?.esic_file?.path}` } target="blank" className='employeeDashBoard-personalLabel'>ESIC Card  <img className='m_b_5 personal-aadhar-size' src={Esic}/></a></p> 
